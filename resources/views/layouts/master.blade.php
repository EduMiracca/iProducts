        ...
        <div class="container"><a href="{{ url('/') }}"><img class="d-flex float-left"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav mx-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="{{ url('/') }}"
                            style="color: #f2af58;">Home</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{ url('/catalogo') }}">Produtos</a>
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{ url('/contato') }}">contato</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{ url('/registro') }}"
                            style="background-color: #ffffff;color: #083b66;">CADASTRE-SE</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{ url('/login') }}"
                            style="background-color: #ffffff;color: #74d14c;">Login</a></li>
                </ul>
            </div><a href="#"><i class="fas fa-heart"
                    style="font-size: 20px;margin-right: 40px;color: rgb(177,17,17);"></i></a><a
                href="shopping-cart.php"><i class="fa fa-shopping-cart"
